...
class Customer
{
  ...
  public:
    ...
    //Pre: None
    //Post: m_name has been assigned a value from names.dat, m_cash has been
    //      assigned a random value in the range [25, 75], m_health has been
    //      assigned a random value in the range [1, 100], m_weight has been
    //      assigned a random value in the range [70, 300], and m_is_alive has
    //      been assigned true 
    Customer();

    //Description: simulates the customer eating a hawt dawg
    //Pre: None
    //Post: m_weight has been increased by WEIGHT_GAIN_FROM_DAWG, and m_cash 
    //      has been decreased by the price the hawt dawg
